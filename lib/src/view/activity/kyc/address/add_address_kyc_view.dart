...
class AddAddressKycView extends StatefulWidget {
...
class AddAddressState extends State<AddAddressKycView> {
  ...
  validateAddress() {
    ...
    CreateAddressRequest request = CreateAddressRequest(
      ...
      lng_location: '10.11',
      lat_location: '10.11',
      city_town: cityController.text,
      current_location: 'chennai'
    );

    KycViewModel.instance.validateCreateAddress(request, context,
        completion: (message, isValidForm) {
      if (isValidForm) {
        KycViewModel.instance.callAddAddressProfile(request,
            completion: (response) {
          setState(() {
