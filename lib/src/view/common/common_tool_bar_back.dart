...
Widget toolBarTransferBackWidget(BuildContext context, String title, bool image, {required Function(String title) completion}) {
        ...
        InkWell(
          onTap: (){
            Navigator.push(context,
              MaterialPageRoute(
                  builder: (context) => AddBankUpiView(title: '',)),); },
      child: Visibility(
            visible: image,
            child: Wrap(
