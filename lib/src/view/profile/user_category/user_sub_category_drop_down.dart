...
Widget widgetUserSubCategoryDropDown(
    BuildContext context, String userSubTypeValue, List<String>? userSubTypeMenuList,
  ...
  return Container(
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton(
          ...
          value: userSubTypeValue,
          icon: const Icon(Icons.arrow_drop_down),
          items: userSubTypeMenuList?.map((String items) {
