...
import 'bank_upi_transfer_view.dart';

class BankUpiTransferRecentListView extends StatefulWidget {
  BankUpiTransferRecentListView({super.key});

  @override
  State<StatefulWidget> createState() => BankUpiTransferRecentListState();
...
class BankUpiTransferRecentListState
    extends State<BankUpiTransferRecentListView> {
      ...
      if (response!.success ?? true) {
        setState(() {
          ...
          if (widget.transferType == 'Bank') {
            selectedType = bankTransfersList!.isNotEmpty
                ? bankTransfersList![0].recipientId!
                : '';
            transfers = bankTransfersList!.isNotEmpty
                ? bankTransfersList![0]
                : Transfers();
            user = User(
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BankUPITransferView()),
                        ).then((val) => val
                            ? callBankGetUserRecipients(userName)
                            : callUpiGetUserRecipients(userName));
                      },
                            ...
                            DropdownButtonHideUnderline(
                              child: DropdownButton(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    loggerNoStack.e(
                                        'selectedTransferCategory value ' +
                                            value!);

                                    for (TransferCategory category
                                        in transferCategoryList) {
                                      loggerNoStack.e('categoryName ' +
                                          category.categoryName!);
                                ...
                                child: Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            StringViewConstants.amountCoins,
                                        hintStyle:
